...
const Card = ({ car }: CardProps) => {
  ...
  return (
    <Link href={`/announcement/${car.id}`}>
      <div className="group m-2 flex h-[342px] w-full min-w-[280px] max-w-xs flex-col justify-between hover:cursor-pointer">
        <div className="relative flex h-36 max-h-36 w-full justify-center border-2 border-grey7 bg-grey7 object-cover transition  group-hover:border-Brand1">
          ...
          {(car.price <= car.fipePrice ||
            (5 / 100) * car.fipePrice >= car.price - car.fipePrice) && (
